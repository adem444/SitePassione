        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm animate-fade-in-up">
          <div className="bg-[#181818] rounded-2xl shadow-2xl w-full max-w-md mx-2 p-0 relative animate-fade-in-up" style={{ boxShadow: '0 8px 32px 0 rgba(98,159,63,0.18)' }}>
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-[#222]">
              ...
              <button
                className="text-gray-400 hover:text-white transition-colors p-1 rounded-full focus:outline-none focus:ring-2 focus:ring-green-500"
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between space-y-3 lg:space-y-0">
          ...
          <div className="flex lg:hidden items-center justify-between w-full">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              <button
                className="flex items-center space-x-2 bg-transparent border-none shadow-none outline-none focus:outline-none focus:ring-2 focus:ring-green-500 font-heading text-lg font-bold p-0 m-0 hover:opacity-80 transition-all"
          ...
          <div className="hidden lg:flex items-center space-x-4 flex-1">
            <button
              className="flex items-center space-x-2 bg-transparent border-none shadow-none outline-none focus:outline-none focus:ring-2 focus:ring-green-500 font-heading text-xl font-bold p-0 m-0 hover:opacity-80 transition-all"
              style={{ boxShadow: 'none' }}
              onClick={() => setModalOpen(true)}
              aria-haspopup="dialog"
              aria-expanded={modalOpen}
