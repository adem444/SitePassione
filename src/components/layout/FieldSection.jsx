...
const defaultPlayers = [
  ...
  { name: 'DEF 3', match: 'VS Club Africain', jerseySrc: '/ess.webp', pos: 'def' },
  { name: 'DEF 4', match: 'VS Club Africain', jerseySrc: '/ess.webp', pos: 'def' },
  { name: 'DEF 5', match: 'VS Club Africain', jerseySrc: '/ess.webp', pos: 'def' },
  { name: 'MID 1', match: 'VS Club Africain', jerseySrc: '/ess.webp', pos: 'mid' },
  { name: 'MID 2', match: 'VS Club Africain', jerseySrc: '/ess.webp', pos: 'mid' },
  { name: 'MID 3', match: 'VS Club Africain', jerseySrc: '/ess.webp', pos: 'mid' },
  { name: 'ATT 1', match: 'VS Club Africain', jerseySrc: '/ess.webp', pos: 'att' },
  { name: 'ATT 2', match: 'VS Club Africain', jerseySrc: '/ess.webp', pos: 'att' },
];
