...
const GiftIcon = () => (
  <svg width="28" height="28" fill="none" viewBox="0 0 24 24">
    ...
    <rect x="11" y="8" width="2" height="10" fill="#61B12C"/>
    <path d="M7 8V6a3 3 0 0 1 6 0v2" stroke="#61B12C" strokeWidth="2"/>
    <path d="M17 8V6a3 3 0 0 0-6 0v2" stroke="#61B12C" strokeWidth="2"/>
  </svg>
);
    ...
    <section className="w-full mt-6 shadow-lg border border-[#353535]" style={{borderRadius:0}}>
      <Tabs.Root value={activeTab} onValueChange={setActiveTab}>
        <Tabs.List className="flex border-b border-[#353535]">
          <Tabs.Trigger value="classement" className={`flex-1 px-4 py-3 text-xl font-bold uppercase tracking-wide text-center transition ${activeTab === 'classement' ? 'bg-[#61B12C] text-white' : 'bg-black text-[#bdbdbd]'} focus:outline-none`} style={{fontFamily:'Bebas Neue, Gotham SSM, sans-serif', borderRadius:0}}>
          ...
          <Tabs.Trigger value="prix" className={`px-4 py-3 flex items-center justify-center transition ${activeTab === 'prix' ? 'bg-[#61B12C] text-white' : 'bg-black text-[#bdbdbd]'} focus:outline-none`} aria-label="Prix" style={{borderRadius:0}}>
            <GiftIcon />
          </Tabs.Trigger>
        </Tabs.List>
        <Tabs.Content value="classement" className="p-0">
          ...
          <div className="flex items-center gap-4 px-4 py-3
           bg-black border-b border-[#353535] justify-center" style={{borderRadius:0}}>
            <span className="text-[#61B12C] text-base font-bold uppercase tracking-wide" style={{fontFamily:'Bebas Neue, Gotham SSM, sans-serif'}}>JOURNÉE</span>
            <button
              className="flex items-center justify-between min-w-[170px] px-2 py-2 bg-[#181818] border-2 border-[#61B12C] text-white text-base font-bold uppercase rounded-full focus:outline-none focus:border-[#61B12C] focus:shadow-[0_0_0_2px_#61B12C] transition-all"
            ...
            >
              ...
              <span className="ml-3 flex items-center">
                <svg width="22" height="22" fill="none" viewBox="0 0 24 24"><path d="M7 10l5 5 5-5" stroke="#61B12C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
              </span>
            </button>
          </div>
                ...
                {classement.map((row, i) => (
                  <tr key={i} className={`${rowBg[i % 2]} transition-all`}>
                    ...
                    <td className="py-3 w-12 align-middle text-center" style={{width:'48px', minWidth:'48px', maxWidth:'48px'}}>
                      <button className="bg-[#61B12C] hover:bg-[#4e7e32] rounded p-2 flex items-center justify-center mx-auto" title="Voir" style={{borderRadius:'6px', width:'32px', height:'32px'}}>
                ...
                <tr key={i} className={`${rowBg[i % 2]} transition-all ${i < prix.length - 1 ? 'border-b border-[#353535]' : ''}`}> 
                  ...
                  <td className="py-4 px-6 align-middle" colSpan={2}>
                    <div className="flex items-center h-full min-h-[40px]">
                      <span className="block font-bold uppercase text-white" style={{fontFamily:'Bebas Neue, Gotham SSM, sans-serif', fontSize:'24px', lineHeight:'32px', textShadow:'0 2px 8px #61B12C55'}}>{row.label}</span>
                    </div>
                  </td>
                </tr>
              ))}
